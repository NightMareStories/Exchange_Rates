                ...
                <div className="g-content-footer__block g-block-footer">
                    ...
                    <nav className="g-block-footer__nav">
                        <ul className="g-block-footer__actions g-actions-footer">
                            <li><a href='https://github.com/NightMareStories/Exchange_Rates.git' className="g-actions-footer__link" target="_blank" rel="noopener noreferrer"><span>GitHub</span></a></li>
